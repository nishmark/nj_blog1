        ...
        >
          <div className="min-w-0">
            ...
            <div className="mt-1 flex items-center gap-x-2 text-xs/5 text-gray-500">
              ...
              <p className="truncate">Created by {blog.author}</p>
            </div>
          </div>
          <div className="flex flex-none items-center gap-x-4">
            ...
            >
              View blog<span className="sr-only">, {blog.title}</span>
            </a>
              ...
              >
                ...
                <MenuItem>
                  <a
                    ...
                    className="block px-3 py-1 text-sm/6 text-gray-900 data-focus:bg-gray-50 data-focus:outline-hidden"
                  >
                    Move<span className="sr-only">, {blog.title}</span>
                  </a>
                </MenuItem>
                <MenuItem>
                  <a
                    ...
                    className="block px-3 py-1 text-sm/6 text-gray-900 data-focus:bg-gray-50 data-focus:outline-hidden"
                  >
                    Delete<span className="sr-only">, {blog.title}</span>
                  </a>
                </MenuItem>
              </MenuItems>
            </Menu>
